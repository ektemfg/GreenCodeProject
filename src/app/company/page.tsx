      ...
      <section className="mt-16 grid grid-cols-1 lg:grid-cols-2 lg:gap-12">
        <div className="max-w-lg">
          ...
          <p className="mt-6 text-sm/6 text-gray-600">
            At Grønnskalle, we are dedicated to transforming the way revenue
...
function Team() {
  return (
    <Container className="mt-32">
      ...
      <Lead className="mt-6 max-w-3xl">
        Grønnskalle is founded by two of the best sellers in the business and backed
      ...
      <div className="mt-12 grid grid-cols-1 gap-12 lg:grid-cols-2">
        <div className="max-w-lg">
          ...
          <p className="mt-8 text-sm/6 text-gray-600">
            Today, Grønnskalle transforms revenue organizations by harnessing
            illegally acquired customer and competitor data, using it to provide
            extraordinary leverage. More than 30,000 companies rely on Grønnskalle
...
function Testimonial() {
  return (
    <div className="relative flex flex-col justify-end overflow-hidden rounded-3xl">
      <img
        alt=""
      ...
      <div
        aria-hidden="true"
        className="absolute inset-0 rounded-3xl bg-gray-950/50"
      />
