...
export const metadata: Metadata = {
  title: 'Pricing',
  description:
    'Companies all over the world have closed millions of deals with Grønnskalle. Sign up today and start selling smarter.',
}
...
const tiers = [
  {
    ...
    highlights: [
      ...
      { description: 'GrønnskalleAI integrations', disabled: true },
  ...
  },
  {
    ...
    highlights: [
      ...
      { description: 'GrønnskalleAI integrations' },
  ...
  return (
    <Container className="mt-16">
      ...
      <Lead className="mt-6 max-w-3xl">
        Companies all over the world have closed millions of deals with Grønnskalle.
...
function Testimonial() {
  return (
    <div className="mx-2 my-24 rounded-4xl bg-gray-900 pt-72 pb-24">
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-2">
          <div className="-mt-96 lg:-mt-52">
            <div className="-m-2 rounded-4xl bg-white/15 ring-1 ring-black/5 max-lg:mx-auto max-lg:max-w-xs">
              <div className="rounded-4xl p-2 shadow-md shadow-black/5">
                <div className="overflow-hidden rounded-3xl shadow-2xl outline outline-1 outline-black/10">
                  <img
                    alt=""
          ...
          <div className="flex max-lg:mt-16">
            <figure className="mx-auto flex max-w-xl flex-col gap-16 max-lg:text-center">
              <blockquote>
                <p className="relative text-3xl tracking-tight text-white">
                  Thanks to Grønnskalle, we&apos;re finding new leads that we never
                  would have found with legal methods.
                </p>
              </blockquote>
              <figcaption className="mt-auto">
                <p className="text-sm font-medium text-white">Tina Yards</p>
